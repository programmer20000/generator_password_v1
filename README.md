...
```commandline
Step number 1. git clone "https://github.com/programmer20000/generator_password_variance_1.git" or download zip
Step number 2. create venv with command python -m venv venv or add interpreter in pycharm
Step number 3. install pakeage with command python -r install requirements.txt
